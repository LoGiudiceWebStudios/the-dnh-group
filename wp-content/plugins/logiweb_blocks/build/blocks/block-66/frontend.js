...
(function () {
  ...
  blocks.forEach(function (block) {
    ...
    function renderGroup(tagLabel, posts) {
      ...
      grid.innerHTML = '<div class="blog-filter-group-header">' + '<h2 class="blog-filter-group-title">' + escHtml(tagLabel) + "</h2>" + '<span class="blog-filter-group-count">' + totalPosts + " article" + (totalPosts !== 1 ? "s" : "") + "</span>" + "</div>" + '<div class="blog-filter-grid">' + posts.map(function (post) {
